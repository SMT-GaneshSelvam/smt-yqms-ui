...
@Component({
  selector: 'app-tag-database-filter',
  templateUrl: './tag-database-filter.component.html',
  styleUrls: ['./tag-database-filter.component.scss']
})
export class TagDatabaseFilterComponent implements OnInit {
