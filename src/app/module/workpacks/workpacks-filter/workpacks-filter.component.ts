...
@Component({
  selector: 'app-workpacks-filter',
  templateUrl: './workpacks-filter.component.html',
  styleUrls: ['./workpacks-filter.component.scss']
})
export class WorkpacksFilterComponent implements OnInit {
